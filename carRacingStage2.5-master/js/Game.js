class Game {
  ...
  if(player.rank === 1){
    ...
    textSize(40);
    fill("blue");
    text("CONGRATULATIONS" + player.name + "YOU ARE THE WINNER", displayWidth/6, -displayHeight * 4 - 80);
  }

  else{
    if(player.rank > 1){
      textSize(25);
      text(player.name + "YOU ARE RANK" + player.rank, displayWidth/6, -displayHeight * 4 - 30);
    }
  }
    ...
    if(allPlayers !== undefined){
      ...
      stroke("yellow");
      strokeWeight(5);
      text("LEADERBOARD", displayWidth/3, -displayHeight * 4 - 200);
